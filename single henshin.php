...
<div style="text-align:center;">
	...
	<audio id="btnSound_axcel" src="accel click.mp3"></audio>
	...
	<script>
		...
		function insertMemory(type) {
			memory = type;  // 直接覆盖（可重选）
			playClick();
			console.log("Memory:", type);
		}

		function playClick() {
			const sound = (memory === "axcel") ? 
				document.getElementById("btnSound_axcel") : 
				(memory === "xtreme") ? 
				document.getElementById("btnSound_xtreme") : 
